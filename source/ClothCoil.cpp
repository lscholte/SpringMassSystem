...
void ClothCoil::updateGeometry(atlas::core::Time<> const &t)
{
    ...
    else
    {
        ...
        {
            deltaLength = std::max(length - mRestLength, 0.9f*mRestLength - mRestLength);            
        }
...
void ClothCoil::applyTransformations()
{
	...
	transformGeometry(glm::scale(glm::mat4(1.0f), glm::vec3(1.0, coilLength, 1.0)));
	...
	this->transformGeometry(glm::translate(glm::mat4(1.0f), midpoint));
}


void ClothCoil::renderGeometry(atlas::math::Matrix4 const &projection, atlas::math::Matrix4 const &view)
{	
